...
import { IDisciplina, Disciplina, Turno } from 'app/shared/model/disciplina.model';
...
describe('Service Tests', () => {
    describe('Disciplina Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Disciplina(0, 'AAAAAAA', Turno.MANHA);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Disciplina', async () => {
